...
- Name: recovery-flow.spec.ts >> recovery flow >> slip → assign → memorize → memorize hub
- Location: e2e/recovery-flow.spec.ts:72:7
...
- main:
  ...
  - separator
  - paragraph: Reflect
  - paragraph: The Messenger of Allah ﷺ said, “Whoever seeks forgiveness for every male and female believer, Allah will record a good deed for him for every male and female believer” (Tabarānī).
  - paragraph: Tafsir
...
```ts
  ...
  2   | 
  3   | const mockAssignment = {
  4   |   assignment: {
  5   |     assignmentId: "e2e-assign-1",
  6   |     arabicText: "وَلَا تَسْتَوِي الْحَسَنَةُ وَلَا السَّيِّئَةُ",
  7   |     ayahNumber: 34,
  8   |     category: "Anger",
  9   |     reflectionPrompt: "What triggered you?",
  10  |     surahName: "Fussilat",
